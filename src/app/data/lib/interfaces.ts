interface IDbContext {
    ...
    orderBy (dbset: string, order: string | string[] ): void;
    skip(dbset: string, count: number): void;
    take(dbset: string, count: number): void;
    default<TEntity>(dbset: string, defaul: TEntity): void;
    ...
    where<TEntity>(dbset: string, predict: Expression < TEntity, boolean | IPredict[] >): void;
}
...
interface IDbSet<TEntity> {
    ...
    orderBy(order: Expression<TEntity, string | string[]>): IDbSet<TEntity>;
...
interface IGenericRepository<TEntity> {
    ...
    getAllBetween<Tkey>(orderBy: Expression<TEntity, string>, skip: number, take: number,
    ...
    getList(predict: Expression < TEntity, boolean | IPredict[] >
              , ... params: Expression<TEntity, Object>[]): Promise<Array<TEntity>>;
    getListBetween<Tkey>(predict: Expression < TEntity, boolean | IPredict[] >, orderBy: Expression<TEntity, string>,
