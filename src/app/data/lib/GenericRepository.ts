...
class GenericRepository<TEntity> implements IGenericRepository<TEntity> {
     ...
     */
    public getAllBetween<Tkey>(orderBy: Expression<TEntity, string>, skip: number, take: number,
     ...
     * @memberOf GenericRepository
     */
    public getListBetween<Tkey>(predict: Expression < TEntity, boolean | IPredict[] >, orderBy: Expression<TEntity, string>,
